...
class Utils:
    ...
    def getLangues(langueID=None):
        datas = {0:"EN", 1:"FR", 2:"FR", 3:"BR", 31:"AF", 4:"ES", 5:"CN", 6:"TR", 7:"VK", 8:"PL", 9:"HU", 10:"NL", 11:"RO", 12:"ID", 13:"DE", 14:"E2", 15:"AR", 16:"PH", 17:"LT", 18:"JP", 19:"CH", 20:"FI", 21:"CZ", 22:"SK", 23:"HR", 24:"BU", 25:"LV", 26:"HE", 27:"IT", 29:"ET", 30:"AZ", 31:"PT"}
        if langueID:
            return datas[langueID]
        return datas
    @staticmethod
    def getLangueID(langue=None):
        datas = {"EN":0, "FR":1, "FR":2, "BR":3,"AF":31, "ES":4, "CN":5, "TR":6, "VK":7, "PL":8, "HU":9, "NL":10, "RO":11, "ID":12, "DE":13, "E2":14, "AR":15, "PH":16, "LT":17, "JP":18, "CH":19, "FI":20, "CZ":21, "SK":22, "HR":23, "BU":24, "LV":25, "HE":26, "IT":27, "ET":29, "AZ":30, "PT":31}
        if langue:
            return datas[langue]
        return 0
