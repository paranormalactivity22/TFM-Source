...
class Lua:
    ...
    def SetupRuntimeGlobals(self): 
        ...
        self.globals['bit32'] = self.runtime.eval('setmetatable({}, {__len = function(self) local count = 0;for i in next, self do count = count+1 end;return count;end})')
        self.globals['bit32']['band'] = lambda x,y: x & y
        ...
        self.globals['system']['luaEventLaunchInterval'] = self.luaEventLaunchInterval
        self.globals['system']['setLuaEventBanner'] = self.setLuaEventBanner
        ...
        self.globals['tfm']['exec']['stopMusic'] = self.stopMusic
        ...
        self.globals['tfm']['get']['room']['xmlMapInfo']['permCode'] = self.room.mapPerma
        self.globals['tfm']['get']['room']['xmlMapInfo']['author'] = self.room.mapName
        self.globals['tfm']['get']['room']['xmlMapInfo']['mapCode'] = self.room.mapCode
        self.globals['tfm']['get']['room']['xmlMapInfo']['xml'] = self.room.mapXML
