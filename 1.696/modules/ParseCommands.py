...
Commands: /resign, /sondage, /colormouse, /colornick, /lsbulle, /execpacket
...
# Arbitre Commands:           
                ...
                if self.client.privLevel >= 7 and self.requireArguments(1):
                    ...
                    if playerName != "":
                        ...
                        self.Ex.Invoke("unknownuserorip")
                ...
                if self.client.privLevel >= 7 and self.requireArguments(1):
                    ...
                    if player != None:
                        ...
                        if not roomName == "" and not roomName == self.client.roomName and not "[Editeur]" in roomName and not "[Totem]" in roomName:
                            ...
                            self.client.sendServerMessage(self.client.playerName+ " has ninja'd the player "+playerName)
                    else:
                        self.Ex.Invoke("unknownuser")
...
# Admins Commands
                ...
                if self.client.privLevel >= 9 and self.requireArguments(1):
                    ...
                    self.client.sendMessage("<V>[•]</V> Successfull added "+str(time)+" seconds to current round.")
